...
var roleDiver = {
    ...
    /** @param {Creep} creep **/
    run: function(creep) {
        if(creep.memory.job == 'quad'){
            if(creep.room.name == 'E0S0') creep.memory.donePortal = true;
            if(!creep.memory.donePortal)creep.travelTo(new RoomPosition(44,44,'E30S10'))
            else creep.travelTo(new RoomPosition(24,24,'E0S0'));
        }
